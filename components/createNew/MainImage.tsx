...
const MainImage = ({ getDocumentName, getDocValues }:createNewProps) => {
  ...
  return (
    ...
    {(mainValueImage !== "" ) ? (
     ...
     <div className=" w-full flex justify-end items-center space-x-1">
      ...
      <div className="  mb-4 w-fit p-1 bg-red-400 rounded-xl flex items-center space-x-1 text-white border-4 border-Blue-Gray " onClick={handleClickFile}>
      ...
      <div className="relative bg-DarkBlueGray w-full h-[22rem] sm:h-[27rem] md:h-[30rem] lg:h-[28rem] xl:h-[32rem] rounded-xl rotate-1  border-4 border-DarkBlueGray" onClick={handleClickFile}>
