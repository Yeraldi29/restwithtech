      ...
      {!editMainTitle ? (
        <>
          <div
            className={`${
              !previewContent &&
              "w-full mb-4 p-2 border-4 border-Blue-Gray rounded-xl"
            } mb-4 `}
          >
            <h1 className="text-2xl xl:text-3xl font-bold text-DarkBlueGray ">
              {valueTitle}
            </h1>
          </div>
          {!previewContent && (
            <div className=" w-full flex justify-end items-center">
              <div
                className="  mb-4 w-fit p-1 bg-DarkBlueGray rounded-xl flex items-center space-x-1 text-white border-4 border-Blue-Gray edit"
        ...
        <>
          <textarea
            className="input rotate-0 h-auto bg-Lavender-Blue/40 text-2xl placeholder:text-2xl placeholder:text-BlueDarker resize-none"
          ...
          {valueTitle !== "" &&
            ...
            !errorTitle.less && (
              <div className=" w-full flex justify-end space-x-1 items-center">
                {loading && <Loading />}
                <div
                  className=" -mt-4 mb-4 w-fit p-1 bg-green-400 rounded-xl flex items-center space-x-1 text-white border-4 border-Blue-Gray saveOrPublish "
                  onClick={handleClickMainTitle}
                >
