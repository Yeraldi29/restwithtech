...
const Input = ({placeholder}:{placeholder:string}) => {
  ...
  return (
    <div className="relative cursor-pointer">
        <div className={`${click && "animate-wiggle text-Blue-Gray"} flex items-center w-11 h-11 bg-gainsboro border border-Lavender-Gray rounded-2xl -rotate-12 lg:hover:rotateItem`} 
        onClick={()=>setClick(true)} onAnimationEnd={()=>setClick(false)}>
        <BiSearch  className=" w-8 h-8 mx-auto -rotate-12"/>
        </div>
        {/* <form>
