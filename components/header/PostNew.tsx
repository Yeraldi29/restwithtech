...
const PostNew = () => {
  ...
  return (
    <Link href={"/postNew"} >
      <div className={`bg-Lavender-Blue rounded-xl text-DarkBlueGray w-24 h-11 xl:h-14  mx-auto mt-3 -mb-5 lg:my-0 flex items-center justify-center border-2 cursor-pointer group ${NewExpand ? "lg:w-28 ": "lg:w-11 xl:w-14"} duration-300 ease-in-out transform overflow-hidden`}
