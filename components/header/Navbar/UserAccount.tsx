...
const UserAccount = () => {
  ...
  return (
    <div className="border-2 border-Blue-Gray mt-6 mx-7 rounded-2xl lg:m-0 lg:w-28 ">
        <div className=" border-b-2 border-Blue-Gray bg-Lavender-Blue rounded-t-xl hover:cursor-pointer lg:w-full hover:opacity-50 active:opacity-100 active:bg-white" onClick={()=>handleClick(false)}>
