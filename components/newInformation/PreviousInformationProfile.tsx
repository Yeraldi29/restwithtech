  ...
  return (
    <div className="lg:col-span-2 relative">
      ...
      <div className=" sm:mx-16 sm:w-auto md:mx-36 lg:sticky top-24 lg:mx-0 lg:h-fit">
       <div className="border-4 text-BlueDarker md:text-lg border-DarkBlueGray rounded-xl w-full mt-4 p-4 bg-Lavender-Blue/40 -rotate-1">
         <div className="rotate-1">
           <div className="flex items-center space-x-3">
             <ImageProfile src={`https://i.pravatar.cc/150?u=${name}`}/>
             <h4 className=" font-semibold xl:text-lg">Lorem Ipsum</h4>
           </div>
           <p className="mt-2 xl:text-lg">
            ...
            <h5 className=" font-semibold xl:text-lg text-BabyBlueEyes">{t("skills")}</h5>
            <ul className=" list-disc ml-4 text-base">
              <li>litora habitasse</li>
              <li>ultrices</li>
              <li>vitae sem nec</li>
            </ul>
            <h5 className=" font-semibold xl:text-lg text-BabyBlueEyes">{t("thisUser")} <span className="text-base text-DarkBlueGray"> Potenti aliquam lectus</span> </h5>
          </div>
         </div>
        <ArrowDesktop />
      </div>
