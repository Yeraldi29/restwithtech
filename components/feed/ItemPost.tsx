...
const ItemPost = ({image,alt,category,time,index}:itemProps) => {
  ...
  return (
    <div className={`flex items-center group bg-DarkBlueGray w-full -rotate-1 even:rotate-1 h-52 sm:h-56 rounded-xl cursor-pointer ${(index=== 0 || index === 1) && "lg:col-span-1"}`}>
        {
