...
const Carousel = () => {
  ...
  return (
    <>
      <div className="relative overflow-hidden w-full h-[22rem] bg-DarkBlueGray mt-4 rounded-xl -rotate-1 border-4 border-DarkBlueGray sm:h-[27rem] md:h-[30rem] lg:h-[32rem] md:col-span-2 lg:row-span-3">
